...
class MUploadify extends CInputWidget{
    ...
    public $autoresize = true;//param for auto resize
    public $size_x = NULL;// param for auto resize
    public $size_y = NULL;// param for auto resize
    ...
    protected function setBaseOptions(){
        ...
        $this->_options['scriptData']['autoresize']=$this->autoresize;
        $this->_options['scriptData']['model_id']=$this->model_id;
        $this->_options['scriptData']['size_x']=$this->size_x;
        $this->_options['scriptData']['size_y']=$this->size_y;
    }
