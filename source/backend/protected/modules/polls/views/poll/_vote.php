<?php 
$this->btnOptions = "<a class='btn btn-primary btn-sm' href='".Yii::app()->createUrl('/polls/poll/admin')."'>".Yii::t("main","Close")."</a>";
?>
<div class="form">
...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <div class="row">
	...
	<button type="submit" class="btn"><?php echo Yii::t('main','Vote');?></button>
<?php $this->endWidget(); ?>
