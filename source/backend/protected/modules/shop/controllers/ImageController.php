...
class ImageController extends BackendApplicationController
{
	public $_model;
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Image']))
		{
			...
			if($model->save()) {
				$folder = Yii::getPathOfAlias('rootPath').'/'.Yii::app()->controller->module->productImagesFolder; 
	 ...
	 */
	protected function performAjaxValidation($model, $form='image-form')
	{
