...
class ProductSpecificationController extends BackendApplicationController
{
	...
	public function actionView($id)
	{
		$this->render('view',array(
			'model'=>$this->loadModel($id, 'ProductSpecification'),
		));
	}
	...
	public function actionDelete($id)
	{
		if(Yii::app()->request->isPostRequest)
		{
			...
			$this->loadModel($id, 'ProductSpecification')->delete();
