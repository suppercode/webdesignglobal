...
$total = BackendTranslatesModel::getTotalData($paramsTrans['language'], 'tbl_categories','id','published=1');
$page = new CPagination($total);

$page->pageSize = 20;
$curr_page = $page->getCurrentPage();
$data = BackendTranslatesModel::GetListTransCategories($paramsTrans['language'],$page->getLimit(), $page->getOffset());
?>
...
<td width="50"><?php if($value['published']!=''):?>
...
<?php else:?>
<a href="<?php echo Yii::app()->createUrl('translate/filterTranslate/create', array('id'=>$value['id']))?>" class="btn btn-sm btn-primary" style="color: #fff">Translate</a>
<?php endif;?>
</td>
<td width="50">
