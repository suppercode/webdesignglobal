...
$data = BackendTranslatesModel::GetListTransNews($paramsTrans['language'],$page->getLimit(), $page->getOffset());
?>
...
<th align="left"><?php echo Yii::t('app','Content')?></th>
<th align="left"><?php echo Yii::t('app','Content').'&nbsp;('.$languages[$paramsTrans['language']].')'?></th>
