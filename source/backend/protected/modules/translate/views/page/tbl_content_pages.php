...
$total = BackendTranslatesModel::getTotalData($paramsTrans['language'],'tbl_content','id',"type='page'");
$page = new CPagination($total);

$page->pageSize = 20;
$curr_page = $page->getCurrentPage();
$data = BackendTranslatesModel::GetListTransNews($paramsTrans['language'],$page->getLimit(), $page->getOffset(),'page');
?>
...
<?php else:?>
<a href="<?php echo Yii::app()->createUrl('translate/filterTranslate/create', array('id'=>$value['id']))?>" class="btn btn-sm btn-primary" style="color: #fff"><?php echo Yii::t('app','Translate');?></a>
<?php endif;?>
</td>
<td width="50">
