...
$(document).ready(function() {
	...
	$("#nav > li > ul > li").css({"color": "black", "height": "100%", "padding": "0 0 0 5px"});
	...
	$("#nav li > ul").css({"color": "#999", "display": "block", "float": "left", "margin": 0, "padding": "5px", "left": "auto"});
	$("#nav span").css("display","block"); /* show category titles */
